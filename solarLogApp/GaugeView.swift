...
//  solarLogApp
//
//  Created by Holger Preu on 10.04.21.
//
...
class GaugeView: UIView {
    ...
    var innerBezelColor = UIColor(red: 0, green: 0.5, blue: 0.5, alpha: 1)
    var innerBezelWidth: CGFloat = 5
    
    var insideColor = UIColor.white
    
    var segmentWidth: CGFloat = 20
    var segmentColors = [UIColor(red: 1, green: 0.4, blue: 0.4, alpha: 1), UIColor(red: 1, green: 0.71, blue: 0.4, alpha: 1), UIColor(red: 0.96, green: 1, blue: 0.4, alpha: 1), UIColor(red: 0.74, green: 1, blue: 0.4, alpha: 1), UIColor(red: 0.48, green: 1, blue: 0.4, alpha: 1)]
    ...
    func drawBackground(in rect: CGRect, context ctx: CGContext) {
        ...
        // move in a little on each edge, then drawe inner bezel
        let innerBezelRect = rect.insetBy(dx: outerBezelWidth, dy: outerBezelWidth)
        innerBezelColor.set()
        ctx.fillEllipse(in: innerBezelRect)
        
        // finally, move in some more and drawe the inside of our gauge
